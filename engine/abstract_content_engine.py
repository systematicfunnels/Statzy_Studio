...
class AbstractContentEngine(ABC):
    ...
    def initializeFFMPEG(self):
        ...
        if not ffmpeg_path:
            raise Exception("FFmpeg, a program used for automated editing within Statzy Studio was not found on your computer. Please go back to the README and follow the instructions to install FFMPEG")
