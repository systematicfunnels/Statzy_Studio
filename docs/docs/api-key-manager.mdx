---
title: ApiKeyManager in Statzy Studio
sidebar_label: ApiKeyManager
---

# ApiKeyManager in Statzy Studio

ApiKeyManager is a class in the Statzy Studio framework that manages the API keys for different providers. It interacts with the database to get and set API keys.
