---
title: AssetDatabase in Statzy Studio
sidebar_label: AssetDatabase
---

# AssetDatabase in Statzy Studio

The `AssetDatabase` in Statzy Studio is a powerful tool that allows you to manage both local and remote assets. This guide will provide you with examples of how to use the `AssetDatabase`.
